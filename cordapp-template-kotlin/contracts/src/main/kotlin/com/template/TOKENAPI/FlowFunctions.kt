...

{
    ...
    fun inputStateRef(id: UniqueIdentifier): StateAndRef<tokenAPIstate> {
        val criteria = QueryCriteria.LinearStateQueryCriteria(linearId = listOf(id))
        return serviceHub.vaultService.queryBy<tokenAPIstate>(criteria = criteria).states.single()
    }
    fun getTime(id: UniqueIdentifier): Instant {
        ...
        val results = serviceHub.vaultService.queryBy<tokenAPIstate>(queryCriteria)
