...
@InitiatingFlow
@StartableByRPC
class HouseSaleInitiatorFlow(private val linearId: String, private val buyer: String) : FlowLogic<SignedTransaction>(){
    ...
    override fun call(): SignedTransaction {
        ...
        val buyer = serviceHub.identityService.partiesFromName(buyer, false).singleOrNull()
                ?: throw IllegalArgumentException("No match found for Owner $buyer.")
...
class HouseSaleInitiatorFlowResponder(private val counterpartySession: FlowSession) : FlowLogic<Unit>() {

    @Suspendable
    override fun call() {

        val priceNotification = counterpartySession.receive<HouseSaleInitiatorFlow.PriceNotification>().unwrap { it }
