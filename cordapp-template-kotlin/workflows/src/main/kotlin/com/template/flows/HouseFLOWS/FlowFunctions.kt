...
import com.template.tokenschedule.FINALISING_TRANSACTION
import com.template.tokenschedule.GENERATING_TRANSACTION
import com.template.tokenschedule.NOTARIZE_TRANSACTION
import com.template.tokenschedule.SIGNING_TRANSACTION
import com.template.tokenschedule.VERIFYING_TRANSACTION
...

{
    ...
    fun inputStateRef(id: UniqueIdentifier): StateAndRef<House> {
    val criteria = QueryCriteria.LinearStateQueryCriteria(linearId = listOf(id))
    return serviceHub.vaultService.queryBy<House>(criteria = criteria).states.single()
}
    fun getTime(id: UniqueIdentifier): Instant {
        ...
        val results = serviceHub.vaultService.queryBy<House>(queryCriteria)
